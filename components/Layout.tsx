  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-primary-500 selection:text-white flex flex-col overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <motion.div style={{ x: x1, y: y1 }} className="absolute top-0 -left-4 w-96 h-96">
          <div className="w-full h-full bg-primary-600/20 rounded-full mix-blend-screen filter blur-[100px] opacity-30 animate-blob" />
        </motion.div>
        <motion.div style={{ x: x2, y: y2 }} className="absolute top-0 -right-4 w-96 h-96">
          <div className="w-full h-full bg-indigo-600/20 rounded-full mix-blend-screen filter blur-[100px] opacity-30 animate-blob animation-delay-2000" />
        </motion.div>
        <motion.div style={{ x: x3, y: y3Scroll }} className="absolute -bottom-8 left-20 w-80 h-80">
          <div className="w-full h-full bg-blue-600/20 rounded-full mix-blend-screen filter blur-[100px] opacity-30 animate-blob animation-delay-4000" />
        </motion.div>
      </div>
